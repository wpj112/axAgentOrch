...
function AgentForm({ name, description, llmModel, llmTemperature, onChangeName, onChangeDescription, onChangeLlmModel, onChangeLlmTemperature }: AgentFormProps) {
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 10, padding: '16px 18px', background: 'var(--bg-card)' }}>
      ...
      <details style={{ borderTop: '1px solid var(--border)', paddingTop: 12, fontSize: 12, color: 'var(--text-muted)' }}>
        <summary style={{ cursor: 'pointer', fontWeight: 600, marginBottom: 8, color: 'var(--text-secondary)' }}>LLM 覆盖（可选）</summary>
