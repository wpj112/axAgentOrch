        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '0 0 16px' }}>
          <div
            style={{
              ...
              height: 38,
              borderRadius: 12,
              background: 'linear-gradient(180deg, rgba(144,202,249,0.16) 0%, rgba(83,183,255,0.08) 100%)',
          ...
          <div>
            ...
            <div style={{ marginTop: 2, fontSize: 11, color: '#8fb8d8', letterSpacing: 0.6 }}>Agent Workflow Orchestration</div>
          </div>
        </div>
        <Routes>
